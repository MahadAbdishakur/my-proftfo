import "./Style.css"; // make sure the filename matches EXACTLY
    ...
    <>
      ...
      <main className="container">
        ...
        <section id="inventions" className="section">
          ...
          <div className="grid">
            {inventions.map((idea) => <div key={idea} className="card">{idea}</div>)}
          </div>
        </section>

        <section id="vr-ar" className="section">
          <h2>VR / AR</h2>
          <p className="muted">Notes, experiments, and prototypes.</p>
        </section>

        <section id="blog" className="section">
          <h2>Blog</h2>
          <p>Build logs, lessons, and experiments. Coming soon.</p>
        </section>

        <section id="about" className="section">
          <h2>About</h2>
          <p style={{ color: "var(--muted)" }}>
            My name is Mahad Abdishakur. I'm a Muslim first, a man second, and a maker always.
        ...
        <section id="contact" className="section">
          ...
          <div style={{ display: "flex", gap: 12, marginTop: 8 }}>
            <a className="btn" href="mailto:your@email">Email</a>
            <a className="btn secondary" href="https://www.linkedin.com/in/your-profile" target="_blank" rel="noreferrer">LinkedIn</a>
          </div>
        </section>
